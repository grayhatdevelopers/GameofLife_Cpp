...
As proof I've attached all the test runs I had. I started with the fileHandler so there's plenty of material to go around.
...
It is most definitely an O(n) algorithm. The time taken depends linearly on the number of cells.
